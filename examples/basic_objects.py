...
slide["c"].set_object(
    TextboxWithTitle(
        "History",
        "Well-known tabby cats include Think Think, one of two cats belonging to the President of Taiwan, "
        "Tsai Ing-wen. One of the first mass-produced stuffed toys, the Ithaca Kitty, was inspired by a grey "
        "tabby cat with seven toes on each front foot.",
    )
)
